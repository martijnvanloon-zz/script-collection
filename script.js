...
(function ()
{
    ...
    textDiv.style.cssText = 'height: 80px;background-color: #ef4923;color: #fff;font-size: 24px;text-transform: uppercase;letter-spacing: 1px;padding: 0 20px;display: flex;margin: 0 5% 0 0;max-width: 90%;align-self: center;text-align: center;align-items: center;font-family: "Avenir Next LT W02 Bold";'

    // chevron
    chevronDiv.classList.add('glyphicon-chevron-right');
    chevronDiv.style.cssText = 'content: "\e080";font-size: 32px;font-family: "Glyphicons Halflings";margin: 0 0 2px 10px'

    // banner and background
    bannerDiv.setAttribute("id", "patagonia-banner")
    bannerDiv.style.cssText = 'height: 160px;display: flex;flex-direction: row-reverse;background: linear-gradient(0deg, rgba(255,255,255,0.4), rgba(255,255,255,0.7)), url(https://patagonia.wpengine.com/wp-content/uploads/2017/08/20170715_scotland0158_featured-1404x778-c-default.jpg) no-repeat center 24%;'
